                    ...
                    <table class="table align-middle m-0" style="min-width: 100%; overflow-x: auto;">
                        ...
                        <tbody>
                            <tr v-for="room in rooms" :key="room.room_id" class="table-row">
                                ...
                                <td class="p-3">
                                    <b-button size="sm" class="text-nowrap" v-if="room.availability === 'Available'"
                                        variant="success" @click="changeRoomAvailability(room)">
                                        Available
                                    </b-button>
                                    <b-button size="sm" class="text-nowrap" v-else variant="outline-danger"
...
export default {
    ...
    methods: {
        ...
        getAvailabilityClass(availability) {
            return {
                "bg-success text-white": availability === "Available",
                "bg-danger text-white": availability === "Booked"
            };
        },
